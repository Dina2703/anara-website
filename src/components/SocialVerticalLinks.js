    ...
    <div className="fixed flex left-0 top-1/4 z-50 px-3 sm:px-7 lg:px-10 py-2 bg-transparent flex flex-col space-y-3">
      <div className="flex justify-center ">
        <a href="https://www.tiktok.com/" title="ищите в  Tiktok">
          <svg
            ...
            fill="currentColor"
            viewBox="0 0 14 16"
            className=" border p-1 bg-slate-300 rounded-2xl hover:bg-white w-[25px] h-[25px] sm:w-[35px] sm:h-[30px]"
          >
            <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3V0Z" />
          </svg>
          <p className="text-[8px] sm:text-[10px] font-semibold">Tiktok</p>
        </a>
      </div>
      ...
      <div className="flex ">
        <a href="https://wa.me/77477027055" title="напишите в  WhatsApp">
          <svg
            className="fill-green-600 hover:fill-white m-auto w-[25px] h-[25px] sm:w-[35px] sm:h-[30px]"
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
            viewBox="0 0 50 50"
          ...
          <p className="text-[8px] sm:text-[10px] text-green-800 font-semibold">
            WhatsApp
          </p>
        </a>
      </div>
      <div className="flex">
        <a href="https://www.instagram.com/" title="ищите в Instagram">
          ...
          <p className="text-[8px] sm:text-[10px] text-red-700 font-semibold ">
            Instagram
          </p>
        </a>
      </div>
