  ...
  return (
    ...
    >
      ...
      <div className="flex space-x-2 justify-center mr-4 ">
        <button
          type="button"
          className="inline-block sm:px-6 px-3 py-1.5 bg-red-600 text-white font-medium text-xs  rounded-full shadow-md hover:bg-red-700 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out "
        >
