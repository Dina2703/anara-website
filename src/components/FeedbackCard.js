...
const FeedbackCard = ({ title, content, user }) => (
  <div className="flex justify-between flex-col px-5 py-2 rounded-[20px] h-[370px] sm:h-[240px] bg-discount-gradient shadow-md">
    ...
    <div className="text-[14px] ml-auto italic text-white pb-8">
      <p className="font-bold tracking-wider">{user.name}</p>
    </div>
  </div>
);
